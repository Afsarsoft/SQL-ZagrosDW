CREATE OR ALTER PROCEDURE ZagrosDW.BuildDimTime
    @MinDate DATE,
    @MaxDate DATE
AS
/***************************************************************************************************
...
----------------------------------------------------------------------------------------------------
Procedure:      ZagrosDW.BuildDimTime
Create Date:    2021-03-01 (yyyy-mm-dd)
Author:         Surush Cyrus
Description:    Build table ZagrosDW.DimTime  
Call by:        TBD, UI, Add hoc
Steps:          NA
Parameter(s):   None
Usage:          EXEC ZagrosDW.BuildDimTime @MinDate = '1/1/2020',
                                        @MaxDate = '1/31/2022';
****************************************************************************************************
SUMMARY OF CHANGES
...
-------------------------------------------------------------------------------
SET @ErrorText = 'Failed Build Table ZagrosDW.DimTime.';

-- Delete contents of Date Dimension Table
TRUNCATE TABLE ZagrosDW.DimTime;
...
SET @Message = 'Completed Build Table ZagrosDW.DimTime.';
